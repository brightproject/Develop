...
$tinybrowser['link']['image'] = 'http://localhost/Tests/shishi_on_function/images/'; // Image links
$tinybrowser['link']['media'] = 'http://localhost/Tests/shishi_on_function/media/'; // Media links
$tinybrowser['link']['file']  = 'http://localhost/Tests/shishi_on_function/files/'; // Other file links
