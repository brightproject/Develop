...
$CSize = 0; // 1 is variable, 0 is fixed
$CSizeWidth = 100; 
$CSizeHeight = 40; // 1 is variable, 0 is fixed
...
$CBackgroundFile = 'backgrounds/23.gif'; // 1 is random, 0 is fixed
$CBackgroundFillType = 0; // 1 is tiled, 0 is resized

// 3. Fonts settings

// The font used, can be 1 if random chosed from a fonts directory or 0 if specified
$CFontUsed = 0; 
$CFontURL = 'fonts/font31.ttf'; 
