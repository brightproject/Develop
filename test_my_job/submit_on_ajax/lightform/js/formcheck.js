...
var FormCheck = new Class({
	options : {
		...
		alerts : {
			...
			alpha        : "This field accepts alphabetic characters only.",
			alphanum     : "This field accepts alphanumeric characters only.",
			nodigit      : "Здесь не допускаются цифры.",
			digit        : "Please enter a valid integer.",
			digitmin     : "Число должно быть не меньше %0",
			digitltd     : "The value must be between %0 and %1",
			number       : "Please enter a valid number.",
			email        : "Please enter a valid email: <br /><span>E.g. yourname@domain.com</span>",
			spamcheck    : "<span>2 + 3 = ???</span>",
			phone        : "Введите правильный телефон.",
			url          : "Введите url в таком виде: <br /><span> http://www.site.com</span>",
			confirm      : "Это поле отличается от %0",
			differs      : "Значение должно отличаться от %0",
			length_str   : "Текст слишком короткий, он должен быть между %0 и %1",
			lengthmax    : "Текст слишком короткий, он должен быть больше %0 знаков",
			lengthmin    : "Текст слишком короткий, он должен быть не меньше %0 знаков",
			checkbox     : "Проверьте чекбокс",
			radios       : "Выберите радио-кнопку",
	...
	*/
	_validate : function(el) {
		el.errors = [];
		el.isOk = true;
		//On valide l'йlйment qui n'est pas un radio ni checkbox
