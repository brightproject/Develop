...
(function($) {
	...
	if($.validationEngineLanguage){				// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
						...
						"alertTextCheckboxe":"* Этот чекбокс обязателен"},
					"norequired":{ 
					    "regex":"none",
						"alertText":"* Это поле не обязательно"},
					"password":{ 
					    "regex":"none",
					...
					"telephone":{
						"regex":"/^[0-9\-\(\)\ ]+$/",
						"alertText":"* Неверные номер"},	
					"email":{
						"regex":"/^([a-zA-Z0-9]{3,})(((\.|\-|\_)[a-zA-Z0-9]{2,})+)?@([a-z]{3,})(\-[a-z0-9]{3,})?(\.[a-z]{2,})+$/",
						"alertText":"* Не верный email"},	
					"date":{
                         "regex":"/^[0-9]{4}\-\[0-9]{1,2}\-\[0-9]{1,2}$/",
                         "alertText":"* Неверная дата, формат такой: YYYY-MM-DD format"},
					"onlyNumber":{
						"regex":"/^[0-9\ ]+$/",
						"alertText":"* Только цифры"},	
					"noSpecialCaracters":{
						"regex":"/^[0-9a-zA-Z]+$/",
						"alertText":"* Только буквы и цифры"},	
					"ajaxUser":{
