...
<html>
 ...
 $img->load('images/vista_1.jpg'); // выбираем картинку
 ...
 if(!$img->error)
 {
 echo '<img src="upload/'.$name.'.'.$img->info('new_type').'" width="'. echo '<img src="upload/'.$name.'.'.$img->info('new_type').'" width="'.$img->info('new_width').'" height="'.$img->info('new_height').'"><br>' 
